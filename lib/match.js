...
module.exports = function (GameBoard, ) {
  return function Match(config) {
    ...
    match_public.roundNumber = function getRoundNumber() {
    ...
    match_public.matchData = function () {
      var playerData = {};
    ...
    match_public.roundData = function () {
      var roundData = {};
    ...
    match_public.getCurrentRound = function currentRound() {
    ...
    match_private.onRoundStarted = function onRoundStarted() {
